...
/**
 * Classe DAO per gestionar l'accés a la taula `drink_types` de la base de dades.
 * Proporciona operacions per inserir o recuperar tipus de beguda.
 * 
...
public class DrinkTypeDAO {
    ...
    /**
     * Obté l'identificador d'un tipus de beguda pel seu nom.
     * Si no existeix, l'insereix i retorna el nou identificador.
     * 
