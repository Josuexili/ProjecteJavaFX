...
/**
 * Classe DAO (Data Access Object) per gestionar les operacions sobre la taula
 * `users` a la base de dades. Proporciona mètodes per crear, llegir,
 * actualitzar i eliminar usuaris. La connexió a la base de dades s'ha de passar
 * al constructor.
 * 
...
public class UserDAO {
	...
	/**
	 * Obté un usuari a partir del seu nom d'usuari. Molt útil per a la
	 * funcionalitat de login.
	 * 
	 ...
	 * @return true si l'usuari s'ha actualitzat correctament, false en cas
	 *         contrari.
	 * @throws SQLException En cas d'errors en la consulta SQL.
	 */
	...
	private User mapResultSetToUser(ResultSet rs) throws SQLException {
		return new User(rs.getInt("user_id"), rs.getString("username"), rs.getString("password"), rs.getString("email"),
				rs.getString("created_at"), rs.getString("last_login"), rs.getString("last_logout"),
				rs.getString("role"));
	}
