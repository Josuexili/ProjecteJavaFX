 ...
 * <p>
 * Carrega les dades dels països des de la base de dades i les mostra
 * en una taula amb les columnes de codi i nom del país.
 * També mostra l'estat de la càrrega a través d'una etiqueta.
 * </p>
 * 
...
public class CountryController {
     ...
     * <p>
     * Estableix la connexió amb la base de dades, configura les columnes
     * de la taula i carrega la llista de països.
     * </p>
     */
    @FXML
    ...
    /**
     * Carrega la llista de països des de la base de dades i l'assigna
     * a la taula per mostrar-la.
     */
