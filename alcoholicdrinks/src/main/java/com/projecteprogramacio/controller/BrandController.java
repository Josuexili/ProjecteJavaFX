...
/**
 * Controlador per gestionar la visualització i càrrega de les marques (Brand) a
 * la interfície gràfica.
 * 
 * Aquesta classe carrega les dades des de la base de dades mitjançant el DAO i
 * les mostra en una taula (TableView).
 * 
...
public class BrandController {
	...
	@FXML
	private TableColumn<Brand, Integer> colBrandId;
	...
	@FXML
	private TableColumn<Brand, String> colCountryCode;
	 ...
	 * les marques de la base de dades. S'executa automàticament quan es carrega el
	 * FXML.
	 */
	@FXML
	public void initialize() {
		...
		colBrandId.setCellValueFactory(
				cellData -> new javafx.beans.property.SimpleIntegerProperty(cellData.getValue().getBrandId())
						.asObject());
		colName.setCellValueFactory(
				cellData -> new javafx.beans.property.SimpleStringProperty(cellData.getValue().getName()));
		colCountryCode.setCellValueFactory(
	...
	/**
	 * Carrega totes les marques des de la base de dades i les assigna a la taula
