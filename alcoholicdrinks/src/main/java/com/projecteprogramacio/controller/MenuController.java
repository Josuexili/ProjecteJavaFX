...
/**
 * Controlador per gestionar el menú principal de l'aplicació segons el rol de l'usuari.
 * Només mostra el menú complet si l'usuari és administrador.
 * 
...
public class MenuController {
    ...
    /**
     * Crea un nou MenuController amb l'usuari actual i el BorderPane arrel on es mostraran les vistes.
     * 
    ...
    /**
     * Crea i retorna la barra de menú segons el rol de l'usuari.
     * Només els usuaris amb rol "admin" veuen el menú.
     * 
