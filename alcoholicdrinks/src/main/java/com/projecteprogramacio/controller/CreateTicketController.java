 ...
 * <p>
 * Gestiona la selecció de clients, la cerca i selecció de productes, l'afegit
 * de línies a un tiquet i la finalització del tiquet. També permet navegar a la
 * vista de gestió de tiquets.
 * <p>
 * Aquest controlador connecta amb la base de dades mitjançant DAO i actualitza
 * les taules i controls de la UI de manera reactiva.
 * 
...
public class CreateTicketController {
	 ...
	 * <p>
	 * Estableix la connexió a la base de dades, configura les taules i controls, i
	...
	/**
	 * Configura la taula de productes amb les columnes i els controls de quantitat
	 * i afegit.
	 */
	...
	/**
	 * Configura la taula de línies de tiquet amb les columnes i el botó
	 * d'eliminació.
	 */
