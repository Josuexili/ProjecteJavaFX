 ...
 * <p>
 * Aquesta classe s'encarrega de carregar, mostrar, afegir, actualitzar i eliminar
 * begudes de la base de dades. També gestiona la taula que mostra les begudes,
 * així com els camps del formulari per introduir o modificar la informació.
 * <p>
...
public class DrinkController {
    ...
    /**
     * Configura les columnes de la taula amb les propietats corresponents de l'objecte {@code Drink}.
     */
     ...
     * <p>
     * Recull les dades del formulari, crea o recupera els identificadors de tipus i marca,
     * i insereix la beguda a la base de dades.
     * Actualitza la taula i els mapes corresponents després d'afegir la beguda.
     *
    ...
    /**
     * Gestiona l'acció d'actualitzar la beguda seleccionada amb les dades del formulari.
     * <p>
     ...
     * <p>
     * Mostra un diàleg de confirmació abans d'eliminar i actualitza la taula després.
     *
     * @throws SQLException si hi ha un error a la base de dades
     */
    @FXML
