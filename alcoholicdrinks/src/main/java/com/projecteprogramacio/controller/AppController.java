 ...
 * <p>
 * Aquesta classe gestiona la inicialització de la finestra principal, la
 * pantalla de login i la navegació principal segons el rol de l'usuari un cop
 * autenticat.
 * </p>
 * <p>
 * Extén de {@link javafx.application.Application} per gestionar el cicle de
 * vida de l'aplicació JavaFX.
 * </p>
 * 
...
public class AppController extends Application {
	...
	/**
	 * Mètode principal invocat quan s'inicia l'aplicació. Inicialitza la finestra
	 * principal i mostra la vista de login.
	 * 
	 ...
	 * <p>
	 * Crea el layout principal amb un menú (només per administradors) i carrega la
	 * vista inicial segons el rol de l'usuari:
	 * <ul>
