...
/**
 * Classe que representa una marca (Brand) amb un identificador, un nom
 * i un codi de país associat.
 * 
 * Aquesta classe s'utilitza com a model de dades per representar la taula
 * `brands` de la base de dades.
 * 
 * Inclou constructors per crear instàncies noves amb o sense ID (per insercions),
...
public class Brand {
    ...
    /**
     * Constructor amb tots els camps, incloent l'ID.
     * Útil per carregar dades des de la base de dades.
     *
