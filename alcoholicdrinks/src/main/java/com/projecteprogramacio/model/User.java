...
/**
 * Classe que representa un usuari del sistema. Conté informació bàsica com
 * username, contrasenya, email, dates de creació i d’últim accés, i el rol dins
 * de l’aplicació.
 * 
...
public class User {
	 ...
	 */
	public User(int userId, String username, String password, String email, String createdAt, String lastLogin,
			String lastLogout, String role) {
		this.userId = userId;
