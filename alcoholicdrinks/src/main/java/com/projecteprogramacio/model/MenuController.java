...
/**
 * Controlador per crear i gestionar la barra de menú dinàmica segons el rol
 * de l'usuari loguejat.
 * 
 * Aquesta classe construeix un {@link MenuBar} amb diferents opcions disponibles
 * segons el rol de l'usuari (admin, worker, client).
 * També gestiona la càrrega de vistes FXML dins d'un {@link BorderPane} principal.
 * 
...
public class MenuController {
    ...
    /**
     * Crea la barra de menú amb les opcions corresponents segons el rol de l'usuari.
     * 
     * - Admin: veu totes les vistes disponibles.
     * - Worker: només veu l'opció per crear tiquets.
