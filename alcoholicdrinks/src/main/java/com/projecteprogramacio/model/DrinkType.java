 ...
 * `types` de la base de dades, que emmagatzema els diferents tipus de
 * begudes (per exemple, cervesa, vi, licor, etc.).
 * 
 * Inclou constructors per a nous registres i per carregar dades existents,
 * així com mètodes getters i setters per accedir i modificar les propietats.
 * 
...
public class DrinkType {
    ...
    /**
     * Constructor complet amb tots els camps, incloent l'ID.
     * Útil per carregar dades existents de la base de dades.
     *
