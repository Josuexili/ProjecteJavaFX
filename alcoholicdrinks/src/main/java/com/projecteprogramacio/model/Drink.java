 ...
 * de marca i tipus, contingut alcohòlic, descripció, volum, preu, imatge i 
 * noms descriptius addicionals. Està pensada per mapejar la taula `drinks`
 * de la base de dades.
 * 
 * Inclou constructors amb i sense paràmetres, així com mètodes getters i setters
