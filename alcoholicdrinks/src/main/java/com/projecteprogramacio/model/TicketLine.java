...
/**
 * Classe que representa una línia d'un tiquet, que conté informació sobre
 * una beguda específica i la quantitat associada dins del tiquet.
 * 
 * Inclou mètodes per obtenir el subtotal (preu * quantitat) i gestionar les propietats.
 * 
...
public class TicketLine {
    ...
    /**
     * Calcula el subtotal de la línia, que és el preu de la beguda multiplicat per la quantitat.
     * 
    ...
    /**
     * Retorna una representació en format de text de la línia, mostrant la quantitat,
     * el nom de la beguda i el subtotal en euros.
     * 
